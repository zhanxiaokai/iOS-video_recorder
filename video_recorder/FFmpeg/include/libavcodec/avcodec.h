...
typedef struct AVCodecContext {
    ...
    enum AVMediaType_F codec_type; /* see AVMEDIA_TYPE_xxx */
...
attribute_deprecated
AVCodecContext *avcodec_alloc_context2(enum AVMediaType_F);
 ...
 *  we WILL change its arguments and name a few times! */
attribute_deprecated
void avcodec_get_context_defaults2(AVCodecContext *s, enum AVMediaType_F);
#endif
 ...
 */
enum AVMediaType_F avcodec_get_type(enum AVCodecID codec_id);
