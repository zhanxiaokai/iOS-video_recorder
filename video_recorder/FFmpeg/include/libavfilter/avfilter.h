...
typedef struct AVFilterBufferRef {
    ...
    enum AVMediaType_F type;      ///< media type of buffer data
 ...
 */
enum AVMediaType_F avfilter_pad_get_type(const AVFilterPad *pads, int pad_idx);
...
struct AVFilterLink {
    ...
    enum AVMediaType_F type;      ///< filter media type
